...
```
```
Este es un pequeño script muy sencillo para poder automatizar y depurar los correos con formato especial, como el del ejemplo div-ejemplo.txt
```
...
```
```
$ git clone https://github.com/operslinux/Depurar.git
```
```
$ cd Depurar
```
